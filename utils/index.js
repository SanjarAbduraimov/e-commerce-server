...
exports.baseUrl =
  process.env.NODE_ENV !== "production" ? "http://localhost:9999" : "https://api.myloadmanager.com";
  ...
  exports.getModelName = (role) => {
    const collectionName = role.slice(0, 1).toUpperCase() + role.slice(1, role.length);
